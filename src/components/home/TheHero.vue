...
<template>
  <section class="hero_container">
    <div class="hero_text_container">
      <h1>¡HELLO EVERYONE! :b</h1>
      <p>
        TRANSFORMING CONCEPTS INTO EXPERIENCES THROUGH DESIGN, BRINGING IDEAS TO
        LIFE, AND BRIDGING THE GAP BETWEEN THE TANGIBLE AND THE IMAGINARY
      </p>
    </div>
